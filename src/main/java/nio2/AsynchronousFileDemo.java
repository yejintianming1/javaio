...
public class AsynchronousFileDemo {
    ...
    public void testCompletionHandler() throws IOException, InterruptedException {
        ...
        AsynchronousFileChannel ch  = AsynchronousFileChannel.open(Paths.get("/wuyangsheng/p.txt"),StandardOpenOption.READ);
        //读取文件临时ByteBuffer对象
    ...
    public void test2() throws IOException, InterruptedException {
        //若文件p.txt不存在，则创建该文件
        Path path = Paths.get("/wuyangsheng/p.txt");
    ...
    public void test3() throws IOException {
        //打开文件通道，获取异步Channel对象
        AsynchronousFileChannel channel = AsynchronousFileChannel.open(Paths.get("/wuyangsheng/p.txt"),StandardOpenOption.READ);
        //读取文件临时ByteBuffer对象
        ByteBuffer buffer = ByteBuffer.allocate(1024);
        //文件读取位置
        long position = 0;
    ...
    public void test4() throws IOException {
        ...
        //构造写入文件的内容
        ByteBuffer buffer = ByteBuffer.allocate(1024);
        buffer.put("你好，java Blocking I/O new!".getBytes());
        buffer.flip();
